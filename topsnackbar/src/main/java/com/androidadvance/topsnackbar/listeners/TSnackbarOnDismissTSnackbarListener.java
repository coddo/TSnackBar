 ...
 */
public class TSnackbarOnDismissTSnackbarListener extends BaseTSnackbarListener implements SwipeDismissBehavior.OnDismissListener {

    public TSnackbarOnDismissTSnackbarListener(TSnackbar tSnackbar) {
        super(tSnackbar);
    }
